...
\begin{enumerate}
    ...
    \item kemudian jika anda tidak akan mengistal VSCode, maka pilih skip
    \begin{figure}[!htbp]
        \centering
        \includegraphics[width=3cm,height=3cm]{figures/gambar9.png}
        \caption{Penawaran Instal MS VSC}
        \label{offering}
        \end{figure}
        \item kemudian Proses intalasi telah selesai pilih finish
    \begin{figure}[!htbp]
        \centering
        \includegraphics[width=3cm,height=3cm]{figures/gambar12.png}
        \caption{Penawaran Instal MS VSC}
        \label{offering}
        \end{figure}
\end{enumerate}
...
Spyder adalah tools yang dipakai untuk python 
    \begin{figure}[!htbp]
        \centering
        \includegraphics[width=3cm,height=3cm]{figures/Screenshot1.png}
        \caption{Instalasi Selesai}
        \label{akhir}
        \end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item Install dan update aplikasi anakonda
 \begin{figure}[!htbp]
    ...
    \begin{figure}[!htbp]
        \centering
        \includegraphics[width=3cm,height=3cm]{figures/tomyprawoto/444.png}
        \caption{Proses}
        \label{awal}
        \end{figure}
    \item Tunggu proses instalasi hingga selesai
    \begin{figure}[!htbp]
        \centering
        \includegraphics[width=3cm,height=3cm]{figures/tomyprawoto/555.png}
        \caption{Proses}
        \label{awal}
        \end{figure}
    \item installation complete
    \begin{figure}[!htbp]
        \centering
        \includegraphics[width=3cm,height=3cm]{figures/tomyprawoto/666.png}
        \caption{Proses}
        \label{awal}
        \end{figure}
    \item klik skip
    \begin{figure}[!htbp]
        \centering
        \includegraphics[width=3cm,height=3cm]{figures/tomyprawoto/777.png}
        \caption{Proses}
        \label{awal}
        \end{figure}
    \item thanks for installing anaconda3 klik finish
    \begin{figure}[!htbp]
        \centering
        \includegraphics[width=3cm,height=3cm]{figures/tomyprawoto/888.png}
        \caption{Proses}
        \label{awal}
        \end{figure}
